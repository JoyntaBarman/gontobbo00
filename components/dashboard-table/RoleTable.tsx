...
const RoleTable = () => {
    ...
    const [currentPage, setCurrentPage] = useState(0);
                    ...
                    const {data: roleData, loading, totalData} = useFetch(
                        `/api/role?&page=${currentPage}&limit=${perPage}${globalFilter && `&role=${globalFilter}`}`,
     ...
     <div>
            ...
            <Table>
                ...
                <TableBody>
                    ...
                    {/* Data State */}
                    {!loading && roleData?.map((role: RoleType) => (
                        <TableRow key={role?._id}>
                            <TableCell className="font-medium">{role?.name}</TableCell>
                            <TableCell>{role?.description || "No description provided"}</TableCell>
                            <TableCell>
            ...
            <Dialog open={isEditModalOpen} onOpenChange={handleCloseModal}>
                <DialogContent className="max-w-300">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Create or Update a new role to add to your list.
                        </DialogDescription>
                    </DialogHeader>
